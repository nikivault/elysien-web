        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <p className="text-white/80 text-xl leading-relaxed mb-8">
              Continue building your portfolio, growing your audience, and
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-white/70 text-sm">Portfolio Views</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full pl-12 pr-12 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent"
              ...
              <button
                type="submit"
                className="w-full py-4 rounded-xl font-bold text-lg text-white transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-3"
                style={{
                  background:
